...
- (void)viewDidLayoutSubviews {
    ...
    if (self.contentView.frame.size.height == 0) {
        self.contentView.frame = CGRectMake(0, 0, UIScreen.mainScreen.bounds.size.width, UIScreen.mainScreen.bounds.size.height - NavBarHeight);
    }
    // 顶部view的frame
...
//    [cell.subviews makeObjectsPerformSelector:@selector(removeFromSuperview)];
    ...
    vc.tableView.contentInset = UIEdgeInsetsMake(0, 0, CGRectGetHeight(self.titleScrollView.frame)+NavBarHeight + HOME_INDICATOR_HEIGHT + 150, 0);
